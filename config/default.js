...
module.exports = {
    app: {
        ...
        commerceAPI: {
            ...
            parameters: {
                clientId: '8e317bd2-d2cd-464a-a4d6-d635c847ab8d',
                organizationId: 'f_ecom_bfcr_007',
                shortCode: 'qt5gn5mk',
                siteId: 'en-GB'
            }
        },
    ...
    ssrParameters: {
        ...
        proxyConfigs: [
            {
                host: 'qt5gn5mk.api.commercecloud.salesforce.com',
                path: 'api'
            },
            {
                host: 'bfcr-007.dx.commercecloud.salesforce.com',
                path: 'ocapi'
            }
        ]
    }
