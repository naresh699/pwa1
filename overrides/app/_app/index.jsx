...
const App = (props) => {
    ...
    const [closeStore, setCloseStore] = useState(undefined)
    ...
    const {data: privacyPolicy} = useQuery({
        ...
        queryFn: () => {
            return (
                fetch(`${getAppOrigin()}/mobify/proxy/ocapi/s/RefArch/dw/shop/v20_2/content/privacy-policy?client_id=1d763261-6522-4913-9d52-5d947d3b94c4`)
                .then(res => res.json())
                .then((json) => {
                    console.log(json);
                    return json;
                    ...
                    <Box id="app" display="flex" flexDirection="column" flex={1}>
                        ...
                        {closeStore && (
                            ...
                            >
                                ...
                                <Text pl={2}>
                                    {closeStore.name} - {closeStore.address1},{' '}
                                    {closeStore.state_code}, {closeStore.postal_code}
                                </Text>
                            </Box>
                        )}
